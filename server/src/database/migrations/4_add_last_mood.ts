...
export class AddLastMood1705789000004 implements MigrationInterface {
    name = 'AddLastMood1705789000004'

    public async up(queryRunner: QueryRunner): Promise<void> {
        // Ajouter la colonne last_mood
        await queryRunner.query(`
            ALTER TABLE "users" 
            ADD COLUMN IF NOT EXISTS "last_mood" integer;
        `);
        ...
        await queryRunner.query(`
            ...
            UPDATE users
            SET last_mood = LastMoods.last_mood
            FROM LastMoods
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN IF EXISTS "last_mood";`);
    }
}